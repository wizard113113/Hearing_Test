...
public class MenualResult extends AppCompatActivity {
    ...
    int[] ManualRealLeftValue = new int[100];
    int[] ManualRealRightValue = new int[100];
    float PTA_R;
    float PTA_L;
    float MIb;
    float MIw;
...
//        MenualRealLeftValue = intent.getIntArrayExtra("menualleftvalue");
        ...
        ManualRealLeftValue = MenualTest.menualrealleftvalue;
        ManualRealRightValue = MenualTest.menualrealrightvalue;


        l_sextant = Function.sextantfunction(ManualRealLeftValue[2], ManualRealLeftValue[3], ManualRealLeftValue[3], ManualRealLeftValue[4], ManualRealLeftValue[4],
                ManualRealLeftValue[6]);
        r_sextant = Function.sextantfunction(ManualRealRightValue[2], ManualRealRightValue[3], ManualRealRightValue[3], ManualRealRightValue[4], ManualRealRightValue[4],
                ManualRealRightValue[6]);

        l_sextant_text = Function.Resultdgreefunction(l_sextant);
        r_sextant_text = Function.Resultdgreefunction(r_sextant);


        PTA_R = Function.PTAfunction(ManualRealRightValue[2], ManualRealRightValue[3], ManualRealRightValue[4], ManualRealRightValue[5]);
        PTA_L = Function.PTAfunction(ManualRealLeftValue[2], ManualRealLeftValue[3], ManualRealLeftValue[4], ManualRealLeftValue[5]);
        ...
        FrequencyVO frequencydate = new FrequencyVO(0,date_month + "월 " + date_day + "일",date_hour + "시 " + date_minute + "분", ManualRealLeftValue[0],
                ManualRealLeftValue[1], ManualRealLeftValue[2], ManualRealLeftValue[3], ManualRealLeftValue[4], ManualRealLeftValue[5], ManualRealLeftValue[6],
                ManualRealLeftValue[7], ManualRealLeftValue[8], ManualRealRightValue[0], ManualRealRightValue[1], ManualRealRightValue[2], ManualRealRightValue[3],
                ManualRealRightValue[4], ManualRealRightValue[5], ManualRealRightValue[6], ManualRealRightValue[7], ManualRealRightValue[8], l_sextant, r_sextant,
...
//        charView.topLabeles.add("1000");
        ...
        for(int a = 0; 9 > a; a++){ //6은 데이터갯수
            charView.dataO.add(new Double(ManualRealRightValue[a]));
        }
        charView.dataX = new ArrayList<Double>();
        for(int a = 0; 9 > a; a++){
            charView.dataX.add(new Double(ManualRealLeftValue[a]));
        }
